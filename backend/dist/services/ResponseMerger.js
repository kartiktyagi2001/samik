export class ResponseMerger {
    ...
    mergeObjectResponses(responses) {
        const allFields = this.extractAllFields(responses);
    ...
    addObjectFields(obj, prefix, fields) {
    ...
    copyValues(source, target, prefix) {
