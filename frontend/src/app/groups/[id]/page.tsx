...
export default function GroupDetailsPage() {
  ...
  const handleAddApi = async () => {
    ...
    setAdding(true);
    const res = await groupsApi.addApi(groupId, {
      name: newApiName,
      url: newApiUrl,
      method: 'GET',
      timeout: 30000,
  ...
  const handleRemoveApi = async (apiId: string) => {
    ...
    const res = await groupsApi.removeApi(groupId, apiId);
    if (res.success) {
      setGroup(prev => prev ? {
        ...prev,
    ...
    <div className="max-w-4xl mx-auto p-6 space-y-8">
      ...
      <div className="border border-black dark:border-zinc-800 p-4 rounded">
        ...
        <div className="flex items-center gap-2">
          <code className="text-xs text-zinc-800 dark:text-zinc-200 bg-zinc-100 dark:bg-zinc-900 px-2 py-1 rounded truncate flex-1">
            {aggregateUrl}
          </code>
          <Button
            variant="outline"
              ...
              <div key={api.id} className="border border-black dark:border-zinc-800 p-4 rounded">
                <div className="flex justify-between items-start">
                  <div className="flex-1">
                    ...
                    <code className="text-xs text-zinc-800 dark:text-zinc-200 bg-zinc-100 dark:bg-zinc-900 px-2 py-1 rounded mt-2 inline-block">
                      {api.url}
                    </code>
                  ...
                  <Button
                    ...
                    className="border-red-600 dark:hover:bg-red-600 text-red-600 hover:bg-red-600 hover:text-white ml-4"
                  >
